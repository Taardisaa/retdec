...
TEST_F(DeadCodeOptimizerTests, OptimizerHasNonEmptyID) {
  ShPtr<ArithmExprEvaluator> evaluator(StrictArithmExprEvaluator::create());
  ShPtr<DeadCodeOptimizer> optimizer(new DeadCodeOptimizer(module, evaluator));
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExprB(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtB(AssignStmt::create(varB, addOpExprB));
  ShPtr<AddOpExpr> addOpExprA(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ShPtr<AssignStmt> assignStmtA(AssignStmt::create(varA, addOpExprA));
  ShPtr<LtOpExpr> ltOpExpr(LtOpExpr::create(varI, ConstInt::create(4, 64)));
  ShPtr<ForLoopStmt> forLoopStmt(
      ForLoopStmt::create(varI, ConstInt::create(5, 64), ltOpExpr,
                          ConstInt::create(1, 64), assignStmtB, assignStmtA));
  testFunc->setBody(forLoopStmt);

  optimize(module);

  ShPtr<AssignStmt> outAssignStmt(cast<AssignStmt>(testFunc->getBody()));
  ASSERT_TRUE(outAssignStmt) << "expected `AssignStmt`, "
                                "got `"
                             << testFunc->getBody() << "`";
  EXPECT_EQ(outAssignStmt, assignStmtA) << "expected `" << assignStmtA
                                        << "`, "
                                           "got `"
                                        << outAssignStmt << "`";
}

TEST_F(DeadCodeOptimizerTests, ForLoopStmtEndCondEvaluatedToFalseIsOptimized) {
  // for (i = 5; false; i++) {
  //     b = 2 + 4;
  // }
  // a = 1 + 3
  ...
  ShPtr<ForLoopStmt> forLoopStmt(ForLoopStmt::create(
      varI, ConstInt::create(5, 64), ConstBool::create(false),
      ConstInt::create(1, 64), assignStmtB, assignStmtA));
  testFunc->setBody(forLoopStmt);
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AssignStmt> assignStmtA(AssignStmt::create(varA, addOpExprA));
  ShPtr<LtOpExpr> ltOpExpr(LtOpExpr::create(varI, ConstInt::create(4, 64)));
  auto gotoStmt = GotoStmt::create(assignStmtB);
  ...
  ASSERT_TRUE(outForLoopStmt) << "expected `ForLoopStmt`, "
                                 "got `"
                              << testFunc->getBody() << "`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExprA(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ShPtr<AssignStmt> assignStmtA(AssignStmt::create(varA, addOpExprA));
  ShPtr<AddOpExpr> addOpExprEndCond(AddOpExpr::create(varA, varI));
  ShPtr<LtOpExpr> ltOpExpr(
      LtOpExpr::create(addOpExprEndCond, ConstInt::create(4, 64)));
  ShPtr<ForLoopStmt> forLoopStmt(
      ForLoopStmt::create(varI, ConstInt::create(5, 64), ltOpExpr,
                          ConstInt::create(1, 64), assignStmtB, assignStmtA));
  testFunc->setBody(forLoopStmt);
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExprA(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ShPtr<AssignStmt> assignStmtA(AssignStmt::create(varA, addOpExprA));
  ShPtr<GtOpExpr> ltOpExpr(GtOpExpr::create(varI, ConstInt::create(4, 64)));
  ShPtr<ForLoopStmt> forLoopStmt(
      ForLoopStmt::create(varI, ConstInt::create(5, 64), ltOpExpr,
                          ConstInt::create(1, 64), assignStmtB, assignStmtA));
  testFunc->setBody(forLoopStmt);
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AssignStmt> assignStmtInWhile(
      AssignStmt::create(varB, addOpExprInWhile));
  ShPtr<AddOpExpr> addOpExprOutWhile(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ShPtr<AssignStmt> assignStmtOutWhile(
      AssignStmt::create(varA, addOpExprOutWhile));
  ShPtr<WhileLoopStmt> whileLoopStmt(WhileLoopStmt::create(
      ConstBool::create(false), assignStmtInWhile, assignStmtOutWhile));
  ...
  ASSERT_TRUE(outAssignStmt) << "expected `AssignStmt`, "
                                "got `"
                             << testFunc->getBody() << "`";
  EXPECT_EQ(outAssignStmt, assignStmtOutWhile) << "expected `"
                                               << assignStmtOutWhile << "`, "
                                                                        "got `"
                                               << outAssignStmt << "`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<SubOpExpr> subOpExpr(
      SubOpExpr::create(ConstFloat::create(llvm::APFloat(2.0)),
  ...
  ShPtr<WhileLoopStmt> whileLoopStmt(
      WhileLoopStmt::create(subOpExpr, assignStmtInWhile, assignStmtOutWhile));
  testFunc->setBody(whileLoopStmt);
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExpr(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmt(AssignStmt::create(varB, addOpExpr));
  ShPtr<WhileLoopStmt> whileLoopStmt(
      WhileLoopStmt::create(ConstBool::create(true), assignStmt));
  testFunc->setBody(whileLoopStmt);

  optimize(module);

  ShPtr<WhileLoopStmt> outWhileLoopStmt(
      cast<WhileLoopStmt>(testFunc->getBody()));
  ASSERT_TRUE(outWhileLoopStmt) << "expected `WhileLoopStmt`, "
                                   "got `"
                                << testFunc->getBody() << "`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExpr(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmt(AssignStmt::create(varB, addOpExpr));
  auto gotoStmt = GotoStmt::create(assignStmt);
  ASSERT_TRUE(gotoStmt);
  ShPtr<WhileLoopStmt> whileLoopStmt(
      WhileLoopStmt::create(ConstBool::create(true), assignStmt));
  testFunc->setBody(whileLoopStmt);
...
TEST_F(DeadCodeOptimizerTests, IfStmtWithFloatCondEvaluatedToFalseIsOptimized) {
  // if (2.0 - 2.0) {
  //     b = 2 + 4;
  // }
  // a = 1 + 3;
  ...
  ShPtr<AddOpExpr> addOpExprInIf(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtInIf(AssignStmt::create(varB, addOpExprInIf));
  ShPtr<AddOpExpr> addOpExprOutIf(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ShPtr<AssignStmt> assignStmtOutIf(AssignStmt::create(varA, addOpExprOutIf));
  ShPtr<IfStmt> ifStmt(
      IfStmt::create(subOpExpr, assignStmtInIf, assignStmtOutIf));
  ...
  ASSERT_TRUE(outAssignStmt) << "expected `AssignStmt`, "
                                "got `"
                             << testFunc->getBody() << "`";
  EXPECT_EQ(outAssignStmt, assignStmtOutIf) << "expected `" << assignStmtOutIf
                                            << "`, "
                                               "got `"
                                            << outAssignStmt << "`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ASSERT_TRUE(outAssignStmtB) << "expected `AssignStmt`, "
                                 "got `"
                              << testFunc->getBody() << "`";
  EXPECT_EQ(outAssignStmtB, assignStmtInIf) << "expected `" << assignStmtInIf
                                            << "`, "
                                               "got `"
                                            << outAssignStmtB << "`";
  ShPtr<AssignStmt> outAssignStmtA(
      cast<AssignStmt>(outAssignStmtB->getSuccessor()));
  EXPECT_EQ(outAssignStmtA, assignStmtOutIf) << "expected `" << assignStmtOutIf
                                             << "`, "
                                                "got `"
                                             << outAssignStmtA << "`";
}

TEST_F(DeadCodeOptimizerTests, IfStmtWithBoolCondEvaluatedToTrueIsOptimized) {
  // if (true) {
  //     b = 2 + 4;
  // }
  // a = 1 + 3;
  ...
  ShPtr<AssignStmt> assignStmtOutIf(AssignStmt::create(varA, addOpExprOutIf));
  ShPtr<IfStmt> ifStmt(
      IfStmt::create(ConstBool::create(true), assignStmtInIf, assignStmtOutIf));
  testFunc->setBody(ifStmt);
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExprC(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtC(AssignStmt::create(varC, addOpExprC));
  ShPtr<IfStmt> ifStmt(IfStmt::create(ConstBool::create(true), assignStmtC));
  ...
  ASSERT_TRUE(outAssignStmtC) << "expected `AssignStmt`, "
                                 "got `"
                              << testFunc->getBody() << "`";
  EXPECT_EQ(outAssignStmtC, assignStmtC) << "expected `" << assignStmtC
                                         << "`, "
                                            "got `"
                                         << outAssignStmtC << "`";
}
...
TEST_F(
  ...
  ShPtr<AddOpExpr> addOpExprBInCond(
      AddOpExpr::create(varB, ConstInt::create(5, 64)));
  ShPtr<AddOpExpr> addOpExprCInCond(
      AddOpExpr::create(varC, ConstInt::create(4, 64)));
  ShPtr<AddOpExpr> addOpExprB(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtB(AssignStmt::create(varB, addOpExprB));
  ShPtr<AddOpExpr> addOpExprC(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtC(AssignStmt::create(varC, addOpExprC));
  ShPtr<IfStmt> ifStmt(IfStmt::create(addOpExprBInCond, assignStmtC));
  ifStmt->addClause(ConstBool::create(false), assignStmtB);
  ...
  ASSERT_TRUE(outIfStmt) << "expected `IfStmt`, "
                            "got `"
                         << testFunc->getBody() << "`";
  EXPECT_EQ(outIfStmt->getFirstIfCond(), addOpExprBInCond)
      << "expected `" << addOpExprBInCond << "`, "
                                             "got `"
      << outIfStmt->getFirstIfCond() << "`";
  ASSERT_TRUE(outIfStmt->hasElseIfClauses()) << "expected `Else-If clause`";
  auto it = outIfStmt->clause_begin();
  EXPECT_EQ((++it)->first, addOpExprCInCond) << "expected `" << addOpExprCInCond
                                             << "`, "
                                                "got `"
                                             << (++it)->first << "`";
}
...
TEST_F(
  ...
  ShPtr<AddOpExpr> addOpExprC(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtC(AssignStmt::create(varC, addOpExprC));
  ShPtr<IfStmt> ifStmt(IfStmt::create(ConstBool::create(false), assignStmtC));
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExprC(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtC(AssignStmt::create(varC, addOpExprC));
  auto gotoStmt = GotoStmt::create(assignStmtC);
  ASSERT_TRUE(gotoStmt);
  ShPtr<IfStmt> ifStmt(IfStmt::create(ConstBool::create(true), assignStmtB));
  ifStmt->addClause(ConstBool::create(false), assignStmtB);
  ...
  ASSERT_TRUE(outConstBool) << "expected `ConstBool`, "
                               "got `"
                            << (++it)->first << "`";
  EXPECT_EQ(outConstBool->getValue(), false) << "expected `False`, "
                                                "got `"
                                             << outConstBool << "`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AssignStmt> assignStmtB(
      AssignStmt::create(varB, addOpExprInSwitch, breakStmt));
  ShPtr<AddOpExpr> addOpExprOutSwitch(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ShPtr<AssignStmt> assignStmtA(AssignStmt::create(varA, addOpExprOutSwitch));
  ShPtr<SwitchStmt> switchStmt(
      SwitchStmt::create(ConstInt::create(2, 64), assignStmtA));
  ...
  ASSERT_TRUE(outAssignStmtB) << "expected `AssignStmt`, "
                                 "got `"
                              << testFunc->getBody() << "`";
  EXPECT_EQ(outAssignStmtB, assignStmtB) << "expected `" << assignStmtB
                                         << "`, "
                                            "got `"
                                         << outAssignStmtB << "`";
  ShPtr<AssignStmt> outAssignStmtA(
      cast<AssignStmt>(outAssignStmtB->getSuccessor()));
  EXPECT_EQ(outAssignStmtA, assignStmtA) << "expected `" << assignStmtA
                                         << "`, "
                                            "got `"
                                         << outAssignStmtA << "`";
}
...
TEST_F(
  ...
  ShPtr<AddOpExpr> addOpExprInSwitch(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtB(AssignStmt::create(varB, addOpExprInSwitch));
  ShPtr<AddOpExpr> addOpExprOutSwitch(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ShPtr<AssignStmt> assignStmtA(AssignStmt::create(varA, addOpExprOutSwitch));
  ShPtr<SwitchStmt> switchStmt(
  ...
  ASSERT_TRUE(outSwitchStmt) << "expected `SwitchStmt`, "
                                "got `"
                             << testFunc->getBody() << "`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AssignStmt> assignStmtC(
      AssignStmt::create(varC, addOpExprInSwitch, breakStmt));
  auto gotoStmt = GotoStmt::create(assignStmtC);
  ASSERT_TRUE(gotoStmt);
  ...
  ASSERT_TRUE(outConstInt) << "expected `ConstInt`, "
                              "got `"
                           << (++it)->first << "`";
  ShPtr<ConstInt> result(ConstInt::create(4, 64));
  EXPECT_EQ(result->getValue(), outConstInt->getValue()) << "expected `"
                                                         << result << "`, "
                                                                      "got `"
                                                         << outConstInt << "`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExprInSwitch(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtB(AssignStmt::create(
      varB, addOpExprInSwitch, ReturnStmt::create(ConstInt::create(2, 64))));
  ShPtr<AssignStmt> assignStmtC(
      AssignStmt::create(varC, addOpExprInSwitch, ContinueStmt::create()));
  auto gotoStmt = GotoStmt::create(assignStmtC);
  ASSERT_TRUE(gotoStmt);
  ShPtr<AddOpExpr> addOpExprOutSwitch(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ...
  EXPECT_EQ(result->getValue(), outConstInt->getValue()) << "expected `"
                                                         << result << "`, "
                                                                      "got `"
                                                         << outConstInt << "`";
  ASSERT_TRUE(outSwitchStmt->hasDefaultClause()) << "expected `Default clause`";
}
...
TEST_F(DeadCodeOptimizerTests,
  ...
  ShPtr<AddOpExpr> addOpExprInSwitch(
      AddOpExpr::create(ConstInt::create(2, 64), ConstInt::create(4, 64)));
  ShPtr<AssignStmt> assignStmtB(
      AssignStmt::create(varB, addOpExprInSwitch, returnStmt));
  ShPtr<AssignStmt> assignStmtC(
      AssignStmt::create(varC, addOpExprInSwitch, ContinueStmt::create()));
  ShPtr<AddOpExpr> addOpExprOutSwitch(
      AddOpExpr::create(ConstInt::create(1, 64), ConstInt::create(3, 64)));
  ...
  EXPECT_EQ(outAssignStmtB, assignStmtB) << "expected `" << assignStmtB
                                         << "`, "
                                            "got `"
                                         << outAssignStmtB << "`";
  ShPtr<ReturnStmt> outReturnStmt(
      cast<ReturnStmt>(outAssignStmtB->getSuccessor()));
  ASSERT_TRUE(outReturnStmt) << "expected `ReturnStmt`, "
                                "got `"
                             << outAssignStmtB->getSuccessor() << "`";
  EXPECT_EQ(outReturnStmt, returnStmt) << "expected `" << returnStmt << "`, "
                                                                        "got `"
                                       << outReturnStmt << "`";
  ShPtr<AssignStmt> outAssignStmtA(
      cast<AssignStmt>(outReturnStmt->getSuccessor()));
  ASSERT_TRUE(outAssignStmtA) << "expected `AssignStmt`, "
                                 "got `"
